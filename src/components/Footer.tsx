        ...
        <div className="footer_cont">
            {
                ...
                FooterLinkFields.map((q, indexq) => (
                    <div className="links_cont" key={indexq}>
                        <h3>{q.heading}</h3>
                        {
            ...
            <div className="about_our_organization">
                ...
                <p>BRANDS PROTEINS PRE-WORKOUTS INTRA-WORKOUTS POST-WORKOUTS RECOVERY GAINERS FAT LOSS WELLNESS VITAMINS & MINERALS SHOP BY GOAL TOP 10 RECENTLY ADDED TRAIN WITH US CONSULT INDIA’S #1 ONLINE SUPPLEMENT STORE – BEAST NUTRITION MACRO CALCULATOR FITNESS TOOLS AND CALCULATORS BMI CALCULATOR</p>
                <h3>Copyright © 2020 Beast Nutrition.  All Rights Reserved.</h3>
